...
export default function BookItem({ book }) {
  ...
  const [deleteBook, {isLoading: isDeleting, isError}] = useDeleteBookMutation();
      ...
      <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div className="flex items-center justify-between">
          ...
          <div className="text-gray-500 space-x-2">
            <Link to={`update/${id}`} disabled={isDeleting}>
            ...
            <button className="lws-deleteBook" onClick={handleClick} disabled={isDeleting}>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
